  ...
  try {
    ...
    const dashboardData: DashboardData = {
      ...
      summary: {
        ...
        avgEScore: summaryData?.avg_e_score ?? 73.5,
        avgSScore: summaryData?.avg_s_score ?? 77.2,
        avgGScore: summaryData?.avg_g_score ?? 81.6,
        avgCScore: summaryData?.avg_c_score_craft_only ?? 85.0,
        totalCO2eAvoidedKg: summaryData?.total_co2e_avoided_kg_auto ?? 1240,
