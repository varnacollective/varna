      ...
      <div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                ...
                <div>
                  <div className="text-2xl font-sans font-light tracking-tight text-carbon-ink dark:text-warm-stone">
                    <AnimatedCounter value={artisansSupported} delay={delay + 0.25} />
                  </div>
            ...
            {/* Average Wage Ratio */}
            <motion.div
              className={`flex items-center gap-4 border border-slate-mist/20 dark:border-midnight-blue p-4 bg-warm-stone/20 dark:bg-black/10 ${!showCultural ? 'col-span-1 sm:col-span-2' : ''}`}
              initial={{ opacity: 0, x: -15 }}
              animate={{ opacity: 1, x: 0 }}
