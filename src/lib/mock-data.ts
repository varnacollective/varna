...
export const SUPPLIER_CONFIDENCE_CHECKLISTS: Record<string, SupplierConfidenceData> = {
  ...
  "UKHI India Private Limited": {
    score: 52,
    totalConfirmed: "5 of 8 tracked data points confirmed",
    status: "Self-Reported",
    checklist: [
      { item: "Incorporation certificate", status: "verified", score: 1.0 },
      { item: "Tax registration (GSTIN)", status: "verified", score: 1.0 },
      { item: "MSME / Udyam recognition", status: "verified", score: 1.0 },
      { item: "Fair wage compliance affidavit", status: "verified", score: 1.0 },
      { item: "Material origin bills", status: "partial", score: 0.5 },
      { item: "Environmental policy disclosure", status: "lapsed", score: 0.5 },
      { item: "Third-party audit documentation", status: "missing", score: 0.0 },
      { item: "Full chemical screening report", status: "missing", score: 0.0 },
    ],
  },
  UKHI: {
    score: 52,
