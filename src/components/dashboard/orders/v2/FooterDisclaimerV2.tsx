...
export default function FooterDisclaimerV2() {
  return (
    <div className="mt-8 mb-6 p-4 rounded-[18px] bg-[#F4EACF] dark:bg-[#2B2720] border border-[#E8DFC5] dark:border-[#F4EACF]/14 flex items-center justify-center gap-2.5 text-center text-xs text-[#5B564E] dark:text-[#C2BCB0] font-normal leading-relaxed">
